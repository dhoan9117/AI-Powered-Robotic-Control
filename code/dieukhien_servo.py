...
while cap.isOpened():
    ...
    if hand_results.multi_hand_landmarks:
        for hand_lm in hand_results.multi_hand_landmarks:
            ...
            # ⚡ Bolt: Optimize finger counting
            # 💡 What: Replaced temporary list allocation and aggregate operation with simple counter.
            # 🎯 Why: Reduces memory allocation overhead in performance-critical real-time loop.
            # 📊 Impact: O(1) space instead of O(n) array creation/cleanup per frame.
            count = 0
